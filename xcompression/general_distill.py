...
def main():
    ...
    model = BertModel.from_pretrained(args.teacher_model)
    task_distill.decompose(model)
    student_model = CompressedBertModel.from_scratch(args.student_model)
    student_model.load_state_dict(model.state_dict(), True)
