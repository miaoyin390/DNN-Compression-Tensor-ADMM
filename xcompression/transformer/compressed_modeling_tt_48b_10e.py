...
def EmbeddingFactory(config):
    if "embedding_type" in config.__dict__ and config.embedding_type == "ket":
        ...
        word_embeddings = TTEmbedding(input_tt_shape=[175, 175], output_tt_shape=[config.hidden_size],
...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.word_embeddings = TTEmbedding(input_tt_shape=[175, 175], output_tt_shape=[config.hidden_size],
                                           compression_ratio=10)

        # self.position_embeddings = nn.Embedding(
        #     config.max_position_embeddings, config.hidden_size)
        self.position_embeddings = TTEmbedding(input_tt_shape=[32, 16], output_tt_shape=[32, 24], compression_ratio=10)
