...
@register_model
def mobilenetv2_cifar(num_classes=10, pretrained=False, path=None, **kwargs):
    if 'num_classes' in kwargs.keys():
        num_classes = kwargs.get('num_classes')
    model = MobileNetV2(output_size=num_classes, **kwargs)
    if pretrained:
...
if __name__ == "__main__":
    model = timm.create_model('mobilenetv2_cifar', num_classes=10)
