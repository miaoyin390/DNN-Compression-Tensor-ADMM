...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node 4 main.py --model tkc_resnet18 --ratio 3 --epochs 100 --model-path ./saved_models/resnet18_imagenet_admm_tk_0222-022350_model.pt --decompose --lr 0.001 --sched step --decay-epochs 45  --fp16 --num-workers 8 --distributed --save-model --save-log
