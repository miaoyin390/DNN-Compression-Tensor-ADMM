...
#CUDA_VISIBLE_DEVICES=0,1 nohup python -m torch.distributed.launch --nproc_per_node 2 main.py --model resnet18 --ratio 2 --admm --epochs 180 --format tk --pretrained --lr 0.01 --sched step --decay-epochs 55  --fp16 --num-workers 6 --distributed --save-model --save-log > rn18-tk-admm-0.log &

#CUDA_VISIBLE_DEVICES=0,1 nohup python -m torch.distributed.launch --nproc_per_node 2 main.py --model tkc_resnet18 --ratio 2 --epochs 160 --model-path ./saved_models/resnet18_imagenet_admm_tk_0224-175336_model.pt --decompose --lr 0.001 --sched step --decay-epochs 45  --fp16 --num-workers 6 --distributed --save-model --save-log > rn18-tk-ft-0.log &
